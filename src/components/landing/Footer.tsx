          ...
          <div>
            ...
            <p className="text-text-muted text-sm mb-4">
             ...
             <div className="flex gap-4">
              <a href="https://wa.me/552123420309?text=Ol%C3%A1%21+Gostaria+de+saber+mais+sobre+o+Family+Quest." target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white p-2 rounded-full hover:scale-110 transition-transform">
